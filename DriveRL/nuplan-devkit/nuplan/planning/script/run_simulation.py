...
def _seed_everything(seed: int) -> None:
    """Seed simulation dependencies without requiring Lightning.

    The public companion does not ship nuPlan's training stack, where
    ``pytorch_lightning`` was previously pulled in only for this helper.  Keep
    Lightning as an optional compatibility path and seed the runtime libraries
