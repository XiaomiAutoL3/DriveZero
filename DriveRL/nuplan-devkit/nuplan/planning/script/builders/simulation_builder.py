...
def build_simulations(
    ...
    # Import builders lazily.  The cleaned companion intentionally omits
    # nuPlan's training package; the default DriveRL path uses a box
    # observation and a custom planner, neither of which needs the optional
    # ML/training builders during module import.
