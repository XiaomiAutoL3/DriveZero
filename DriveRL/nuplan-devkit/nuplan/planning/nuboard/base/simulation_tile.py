...
class SimulationTile:
    ...
    def _render_map_polygon_layers(self, main_figure: SimulationFigure) -> None:
        ...
        polygon_layer_names = [
            (SemanticMapLayer.DRIVABLE_AREA, simulation_map_layer_color[SemanticMapLayer.DRIVABLE_AREA]),
    ...
    def _render_plots(
        ...
        # Update DriveRL model-input plot.
        main_figure.model_input_plot.update_plot(
            main_figure=main_figure.figure,
            frame_index=frame_index,
            doc=self._doc,
        )
